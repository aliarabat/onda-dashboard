...
public class PeriodUtil {
	...
	public static Timing getDuration(int startingHour, int startingMinute, int endingHour, int endingMinute) {
		List<Timing> model = new LinkedList<>(Arrays.asList(new Timing(1), new Timing(2), new Timing(3), new Timing(4),
				new Timing(5), new Timing(6), new Timing(7), new Timing(8), new Timing(9), new Timing(10),
				new Timing(11), new Timing(12), new Timing(13), new Timing(14), new Timing(15), new Timing(16),
				new Timing(17), new Timing(18), new Timing(19), new Timing(20), new Timing(21), new Timing(22),
				new Timing(23), new Timing(00)));

...
public class EquipementConverter extends AbstractConverter<Equipement, EquipementVo> {
	...
	public Equipement toItem(EquipementVo vo) {
		if (vo == null) {
			...
			equipement.setExpectedBreakPeriodMaintenance(
					new TimingConverter().toItem(vo.getExpectedBreakPeriodMaintenance()));
	...
	public EquipementVo toVo(Equipement item) {
		if (item == null) {
			...
			equipementVo.setExpectedBreakPeriodMaintenance(
					new TimingConverter().toVo(item.getExpectedBreakPeriodMaintenance()));
